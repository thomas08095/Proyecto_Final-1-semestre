...
public class NodoEnergia {
    ...
    public int[] getFilaNE() { return filaNE; }
    public void setFilaNE(int[] filaNE) { this.filaNE = filaNE; }

    public int[] getColumnaNE() { return columnaNE; }
    public void setColumnaNE(int[] columnaNE) { this.columnaNE = columnaNE; }
